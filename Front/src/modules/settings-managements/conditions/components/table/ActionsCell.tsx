...
import { deleteConditionById } from '../../core/requests/delete_requests'
...
export const ActionsCell: FC<Props> = ({ condition }) => { 
  ...
  try {
    setLoading(true)
    const response = await deleteConditionById(condition?.id)
  ...
  return (
    <div className='flex justify-center'>
      ...
      >
        <p>Vous etes sur de supprimer le dd {condition.id} </p>
      </Modal>
    </div>
  )
}
